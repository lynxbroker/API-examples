...
### The [TWSConnection.java](https://gitlab.lynx-trader.com/documentation/articles/blob/master/Java/request_market_data/src/TWSConnection.java) class:
...
### The [Main.java](https://gitlab.lynx-trader.com/documentation/articles/blob/master/Java/request_market_data/src/Main.java) class:
...
![](images/console_response_market_data.png)
