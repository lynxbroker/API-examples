...
profit_order.lmtPrice = '12'
profit_order.orderId = app.nextorderId
app.nextorderId += 1
profit_order.parentId = order.orderId
order.transmit = True

app.placeOrder(order.orderId, contract, order)
app.placeOrder(profit_order.orderId, contract, profit_order)
